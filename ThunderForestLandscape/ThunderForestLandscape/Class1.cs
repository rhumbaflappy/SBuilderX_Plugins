...
namespace ThunderForestLandscapeServer
{
    public class ThunderForestLandscape : IServer
    {
        ...
        public ThunderForestLandscape()
        {
            this.URL = new string[3];
            this.BaseImageType = ".png";
            this.BaseMaximumZoom = 17;
            this.BaseServerName = nameof(ThunderForestLandscape);
            this.BaseURL0 = "http://a.tile.thunderforest.com/landscape/";
            this.BaseURL1 = "http://b.tile.thunderforest.com/landscape/";
            this.BaseURL2 = "http://c.tile.thunderforest.com/landscape/";
        }
